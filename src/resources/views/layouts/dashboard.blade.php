...
-->
    <div x-data="{open: false}">
        ...
        <div class="fixed inset-0 z-40 flex md:hidden" role="dialog" aria-modal="true" x-show="open" x-transition x-cloak>
            ...
            <div class="relative flex flex-col flex-1 w-full bg-gray-800">
                <div class="flex-1 h-0 pt-4 pb-4 overflow-y-auto">
                    <div class="absolute top-0 right-0 mx-2 my-3">
                        <button type="button" class="flex items-center justify-center w-10 h-10 ml-1 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" x-on:click="open = false">
                            <span class="sr-only">Close sidebar</span>
                            <svg class="w-8 h-8 text-gray-400 hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    ...
                    <nav class="px-2 mt-5 space-y-1">
                        ...
                        <a href="{{ route('dashboard.notifications') }}" class="flex items-center p-3 text-xl font-semibold rounded-md group {{ request()->routeIs('dashboard.notifications') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            <svg class="flex-shrink-0 w-8 h-8 mr-5 text-gray-400 group-hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="{{ route('dashboard.properties.index') }}" class="flex items-center p-3 text-xl font-semibold rounded-md group {{ request()->routeIs('dashboard.properties.*') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-8 h-8 mr-5 text-gray-400 group-hover:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="{{ route('dashboard.settings.index') }}" class="flex items-center p-3 text-xl font-semibold rounded-md group {{ request()->routeIs('dashboard.settings') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            <svg class="flex-shrink-0 w-8 h-8 mr-5 text-gray-400 group-hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex flex-col flex-1 min-h-0 bg-gray-800">
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="flex-1 px-2 mt-5 space-y-1">
                        ...
                        <a href="{{ route('dashboard.notifications') }}" class="flex items-center px-2 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('dashboard.notifications') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            <svg class="flex-shrink-0 w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                            </svg>
                            Notifications
                            <span class="bg-red-500 ml-auto inline-block py-0.5 px-3 text-sm rounded-full text-red-200">5</span>
                        ...
                        <a href="{{ route('dashboard.settings.index') }}" class="flex items-center px-2 py-2 text-sm font-medium rounded-md group {{ request()->routeIs('dashboard.settings.*') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            <svg class="flex-shrink-0 w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            Settings
                ...
                <div class="flex flex-shrink-0 p-4 bg-gray-700">
                    <a href="#" class="flex-shrink-0 block w-full group">
                        <div class="flex items-center">
                            <div>
                                <img class="inline-block rounded-full h-9 w-9" src="https://ui-avatars.com/api/?background=6366f1&color=fff&name={{ Auth::user()->fullName('+') }}" alt="">
                            </div>
                            <div class="ml-3">
                                <p class="text-sm font-medium text-gray-300 capitalize group-hover:text-white">
                                    {{ Auth::user()->fullName() }}
                                </p>
        ...
        <div class="flex flex-col flex-1 md:pl-64">
            ...
            <!-- Top Bar for Mobile -->
            <div class="sticky top-0 z-10 flex justify-between p-2 bg-gray-800 md:hidden sm:pl-3 sm:pt-3">
                ...
                <button type="button" class="-ml-0.5 -mt-0.5 h-12 w-12 inline-flex items-center justify-center rounded-md text-gray-500 hover:text-gray-900 focus:outline-none" x-on:click="open = true">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute top-0 right-0 w-2 h-2">
                            <span class="absolute top-0 block w-1 h-1 bg-red-500 rounded-full right-1 ring-2 ring-red-500"></span>
                            <span class="absolute top-0 block w-1 h-1 bg-red-500 rounded-full right-1 ring-4 ring-red-500 animate-ping"></span>
                        </div>
                    </div>
                </button>
            </div>
            ...
            <main class="flex-1">
                <div class="max-w-screen-md py-6 space-y-6">
                    <div class="px-6 mx-auto tracking-wide">
                        <h1 class="text-2xl font-bold text-gray-900">{{ $header ?? 'SET HEADER AND SUBHEADER' }}</h1>
                        <h2 class="text-sm italic">{{ $subheader ?? null }}</h2>
                    </div>
